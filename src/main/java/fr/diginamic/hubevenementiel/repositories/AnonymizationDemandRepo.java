...
public interface AnonymizationDemandRepo extends JpaRepository<AnonymizationDemand, Long> {
     ...
     *                 PageRequest.of()
     * @return a list of anonymization demand requests by a date between a min data
     *         and max date with pagination info
     */
     ...
     * @param pageable settings for the pagination, create a peagble object using
     *                 PageRequest.of()
     * @return a list of anonymization demand approved by a date between a min data
     *         and max date with pagination info
     */
    ...
    /**
     *
     * @param id       id of the requester you want to find all the anonymization
     *                 demand for
     * @param pageable settings for the pagination, create a peagble object using
     *                 PageRequest.of()
     * @return a list of anonymmizationDemand from a specific requester with
     *         pagination info
     */
    ...
    /**
     *
     * @param lastName last name of the requester you want to find all the
     *                 anonymization demand for
     * @param pageable settings for the pagination, create a peagble object using
     *                 PageRequest.of()
     * @return a list of anonymmizationDemand from a specific requester with
     *         pagination info
    ...
    /**
     *
     * @param firstName first name of the requester you want to find all the
     *                  anonymization demand for
     * @param pageable  settings for the pagination, create a peagble object using
     *                  PageRequest.of()
     * @return a list of anonymmizationDemand from a specific requester with
    ...
    /**
     *
     * @param email    email of the requester you want to find all the anonymization
     *                 demand for
     * @param pageable settings for the pagination, create a peagble object using
     *                 PageRequest.of()
     * @return a list of anonymmizationDemand from a specific requester with
    ...
    /**
     *
     * @param id       id of the admin you want to find all the anomization demand
     *                 for
     * @param pageable settings for the pagination, create a peagble object using
     *                 PageRequest.of()
     * @return a list of anonymmizationDemand from a specific admin with pagination
     *         info
     */
    ...
    /**
     *
     * @param lastName last name of the admin you want to find all the anomization
     *                 demand for
     * @param pageable settings for the pagination, create a peagble object using
     *                 PageRequest.of()
     * @return a list of anonymmizationDemand from a specific admin with pagination
    ...
    /**
     *
     * @param firstName first name of the admin you want to find all the anomization
     *                  demand for
     * @param pageable  settings for the pagination, create a peagble object using
     *                  PageRequest.of()
     * @return a list of anonymmizationDemand from a specific admin with pagination
    ...
    /**
     *
     * @param email    email of the admin you want to find all the anomization
     *                 demand for
     * @param pageable settings for the pagination, create a peagble object using
     *                 PageRequest.of()
     * @return a list of anonymmizationDemand from a specific admin with pagination
